...
public class MMLTools {
    ...
    public static Recommendation getRecommendation(Connection connection, int fromID, int toID, int songID, boolean isAutoGenerated) throws SQLException {
        return new Recommendation(isAutoGenerated, getSong(connection, songID), getUser(connection, fromID),
                getUser(connection, toID));
    }
    ...
    public static Recommendation[] findPersonalRecommendations(Connection connection, User user) throws SQLException {
        ...
        int i = 0;
        while (resultSet.next()) {
            Recommendation recommendation = getRecommendation(connection, resultSet.getInt(3),
